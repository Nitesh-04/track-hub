...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative w-full bg-[#a3d6eb]">
      <GridPattern
      ...
      <div className="relative z-10 mt-56 md:mt-32 mb-56 md:mb-48 px-8 md:px-20 flex items-center justify-center md:gap-20">
